...
-file("/code/src/erlang_red_binary_type_leex.erl", 341).
yystate() -> 12.
...
yystate(12, [69|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(6, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(12, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 49, C =< 57 ->
...
-file("/code/src/erlang_red_binary_type_leex.xrl", 30).
yyaction_0() ->
     skip_token .

-compile({inline,yyaction_1/2}).
-file("/code/src/erlang_red_binary_type_leex.xrl", 32).
yyaction_1(TokenChars, TokenLine) ->
     { token, { hexadecimal, TokenLine, TokenChars } } .

-compile({inline,yyaction_2/2}).
-file("/code/src/erlang_red_binary_type_leex.xrl", 33).
yyaction_2(TokenChars, TokenLine) ->
     { token, { binary, TokenLine, TokenChars } } .

-compile({inline,yyaction_3/2}).
-file("/code/src/erlang_red_binary_type_leex.xrl", 34).
yyaction_3(TokenChars, TokenLine) ->
     { token, { integer, TokenLine, TokenChars } } .

-compile({inline,yyaction_4/1}).
-file("/code/src/erlang_red_binary_type_leex.xrl", 36).
yyaction_4(TokenLine) ->
     { token, { '-', TokenLine } } .

-compile({inline,yyaction_5/1}).
-file("/code/src/erlang_red_binary_type_leex.xrl", 37).
yyaction_5(TokenLine) ->
     { token, { '.', TokenLine } } .
