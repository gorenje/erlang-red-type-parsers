...
-module(erlang_red_binary_type_leex).

-export([string/1,string/2,token/2,token/3,tokens/2,tokens/3]).
-export([format_error/1]).

%% User code. This is placed here to allow extra attributes.
-file("/code/src/erlang_red_binary_type_leex.xrl", 60).
...
-file("/code/src/erlang_red_binary_type_leex.erl", 350).
yystate() -> 21.

yystate(24, Ics, Line, Col, Tlen, _, _) ->
    {10,Tlen,Ics,Line,Col};
yystate(23, [32|Ics], Line, Col, Tlen, _, _) ->
    yystate(23, Ics, Line, Col, Tlen+1, 0, Tlen);
yystate(23, [13|Ics], Line, Col, Tlen, _, _) ->
    yystate(23, Ics, Line, Col, Tlen+1, 0, Tlen);
yystate(23, [9|Ics], Line, Col, Tlen, _, _) ->
    yystate(23, Ics, Line, Col, Tlen+1, 0, Tlen);
...
yystate(21, [69|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(9, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(21, [48|Ics], Line, Col, Tlen, Action, Alen) ->
...
yystate(21, [10|Ics], Line, _, Tlen, Action, Alen) ->
    yystate(23, Ics, Line+1, 1, Tlen+1, Action, Alen);
yystate(21, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 49, C =< 57 ->
...
yystate(16, [13|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(8, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(16, [11|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(4, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(16, [12|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(4, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(16, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 0, C =< 8 ->
    yystate(4, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(16, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 14, C =< 31 ->
    yystate(4, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(16, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 33, C =< 38 ->
    yystate(4, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(15, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 11, C =< 33 ->
    yystate(15, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(15, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 35 ->
    yystate(15, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(15, Ics, Line, Col, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,Col,15};
yystate(14, [48|Ics], Line, Col, Tlen, _, _) ->
    yystate(14, Ics, Line, Col, Tlen+1, 4, Tlen);
yystate(14, [49|Ics], Line, Col, Tlen, _, _) ->
    yystate(14, Ics, Line, Col, Tlen+1, 4, Tlen);
yystate(14, Ics, Line, Col, Tlen, _, _) ->
    {4,Tlen,Ics,Line,Col,14};
...
yystate(11, [34|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(19, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(11, [33|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(15, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(11, [13|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(11, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(11, [11|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(15, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(11, [12|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(15, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(11, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 0, C =< 8 ->
    yystate(15, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(11, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 14, C =< 31 ->
    yystate(15, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(11, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 35 ->
    yystate(15, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(11, Ics, Line, Col, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,Col,11};
yystate(10, [48|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(14, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(10, [49|Ics], Line, Col, Tlen, Action, Alen) ->
    yystate(14, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(8, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 14, C =< 31 ->
    yystate(4, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(8, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 33, C =< 38 ->
    yystate(4, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(6, [C|Ics], Line, Col, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(6, Ics, Line, Col, Tlen+1, 3, Tlen);
...
yystate(3, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 14, C =< 31 ->
    yystate(15, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(3, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 35 ->
    yystate(15, Ics, Line, Col, Tlen+1, Action, Alen);
...
yystate(2, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 65, C =< 70 ->
    yystate(6, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(2, [C|Ics], Line, Col, Tlen, Action, Alen) when C >= 97, C =< 102 ->
    yystate(6, Ics, Line, Col, Tlen+1, Action, Alen);
yystate(2, Ics, Line, Col, Tlen, Action, Alen) ->
    {Action,Alen,Tlen,Ics,Line,Col,2};
yystate(1, [120|Ics], Line, Col, Tlen, _, _) ->
...
yystate(1, [88|Ics], Line, Col, Tlen, _, _) ->
    yystate(2, Ics, Line, Col, Tlen+1, 5, Tlen);
yystate(1, [66|Ics], Line, Col, Tlen, _, _) ->
    yystate(10, Ics, Line, Col, Tlen+1, 5, Tlen);
...
-file("/code/src/erlang_red_binary_type_leex.xrl", 35).
yyaction_0() ->
     skip_token .

-compile({inline,yyaction_1/1}).
-file("/code/src/erlang_red_binary_type_leex.xrl", 38).
yyaction_1(TokenChars) ->
     { skip_token, remove_quotes (TokenChars) } .

-compile({inline,yyaction_2/1}).
-file("/code/src/erlang_red_binary_type_leex.xrl", 39).
yyaction_2(TokenChars) ->
     { skip_token, remove_quotes (TokenChars) } .

-compile({inline,yyaction_3/2}).
-file("/code/src/erlang_red_binary_type_leex.xrl", 41).
yyaction_3(TokenChars, TokenLine) ->
     { token, { hexadecimal, TokenLine, TokenChars } } .

-compile({inline,yyaction_4/2}).
-file("/code/src/erlang_red_binary_type_leex.xrl", 42).
yyaction_4(TokenChars, TokenLine) ->
     { token, { binary, TokenLine, TokenChars } } .

-compile({inline,yyaction_5/2}).
-file("/code/src/erlang_red_binary_type_leex.xrl", 43).
yyaction_5(TokenChars, TokenLine) ->
     { token, { integer, TokenLine, TokenChars } } .

-compile({inline,yyaction_6/0}).
-file("/code/src/erlang_red_binary_type_leex.xrl", 45).
yyaction_6() ->
     skip_token .

-compile({inline,yyaction_7/1}).
-file("/code/src/erlang_red_binary_type_leex.xrl", 46).
yyaction_7(TokenLine) ->
     { token, { '-', TokenLine } } .

-compile({inline,yyaction_8/1}).
-file("/code/src/erlang_red_binary_type_leex.xrl", 47).
yyaction_8(TokenLine) ->
     { token, { '.', TokenLine } } .

-compile({inline,yyaction_9/1}).
-file("/code/src/erlang_red_binary_type_leex.xrl", 48).
yyaction_9(TokenLine) ->
     { token, { e, TokenLine } } .

-compile({inline,yyaction_10/1}).
-file("/code/src/erlang_red_binary_type_leex.xrl", 49).
yyaction_10(TokenLine) ->
     { token, { ',', TokenLine } } .

-compile({inline,yyaction_11/1}).
-file("/code/src/erlang_red_binary_type_leex.xrl", 51).
yyaction_11(TokenLine) ->
     { token, { '[', TokenLine } } .

-compile({inline,yyaction_12/1}).
-file("/code/src/erlang_red_binary_type_leex.xrl", 52).
yyaction_12(TokenLine) ->
     { token, { ']', TokenLine } } .

-compile({inline,yyaction_13/0}).
-file("/code/src/erlang_red_binary_type_leex.xrl", 55).
yyaction_13() ->
     { skip_token, "0x0" } .

-compile({inline,yyaction_14/0}).
-file("/code/src/erlang_red_binary_type_leex.xrl", 56).
yyaction_14() ->
     { skip_token, "0x0" } .
